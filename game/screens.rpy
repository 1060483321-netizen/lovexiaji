...
screen navigation():
    ...
    if main_menu:
        ...
        frame:
            ...
            vbox:
                style_prefix "landing"

                xfill True
                spacing 16

                textbutton _("开始阅读") action Start()
                textbutton _("章节选读") action ShowMenu("chapter_select")
                ...
                hbox:
                    ...
                    textbutton _("关于") action ShowMenu("about") style "landing_secondary_button"

                    if renpy.variant("pc"):
                        textbutton _("退出") action Quit(confirm=True) style "landing_secondary_button"
        ...
        vbox:
            ...
            if _in_replay:
                ...
                textbutton _("结束回想") action EndReplay(confirm=True)
...
style landing_panel is empty
style landing_button is button
style landing_button_text is button_text
style landing_secondary_button is button
style landing_secondary_button_text is button_text
style landing_title_frame is empty
style landing_title is main_menu_title
style landing_subtitle is main_menu_version
style landing_meta is main_menu_version
...
style landing_panel:
    ...
    xpadding 28
    ypadding 26
    background Solid("#2a171bc8")

style landing_button:
    xfill True
    ysize 58
    left_padding 24
    right_padding 24
    top_padding 10
    bottom_padding 10
    background Solid("#fff1de16")
    hover_background Solid("#fff1de30")
    insensitive_background Solid("#fff1de10")

style landing_button_text:
    size 28
    color "#fff4e6"
    hover_color "#ffffff"
    selected_color "#ffffff"
    insensitive_color "#fff4e680"
    xalign 0.5
    textalign 0.5

style landing_secondary_button:
    xfill True
    ysize 42
    left_padding 12
    right_padding 12
    ...
    hover_background Solid("#fff1de18")
    insensitive_background Solid("#00000000")

style landing_secondary_button_text:
    size 18
    color "#dcccc0"
    hover_color "#fff8ef"
    selected_color "#fff8ef"
    insensitive_color "#dcccc080"
    xalign 0.5
    textalign 0.5
...
style landing_title:
    size 76
    color "#fff4e7"
    outlines [ (2, "#3d2022", 0, 0), (6, "#12090a40", 0, 0) ]

style landing_subtitle:
    size 23
    color "#e6d7c7"
    outlines [ (2, "#2a1718", 0, 0) ]

style landing_meta:
    size 18
    color "#ccbba8"
    outlines [ (1, "#241314", 0, 0) ]
    ...
    use game_menu(_("章节选读"), scroll="viewport"):
        ...
        vbox:
            ...
            grid 3 10:
                ...
                for no, label_name in chapter_entries:

                    textbutton "第[no]章":
                        action Start(label_name)


style chapter_vbox is vbox
style chapter_text is gui_text
...
style chapter_button:
    ...
    bottom_padding 10
    background Solid("#fff1de16")
    hover_background Solid("#fff1de2a")
    insensitive_background Solid("#fff1de10")
...
screen about():
    ...
    use game_menu(_("关于"), scroll="viewport"):
        ...
        vbox:
            ...
            text gui.about
            null height 18
            text _("当前状态：主菜单、章节入口、基础立绘与场景映射已接入。")
            null height 10
        ...
        fixed:
            ...
            hbox:
                ...
                if config.has_autosave:
                    textbutton _("自") action FilePage("auto")

                if config.has_quicksave:
                    textbutton _("快") action FilePage("quick")
